    ...
    <div className="pt-24 pb-20 min-h-screen bg-black page-transition-enter">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-gray-400 mb-16 max-w-2xl mx-auto">
          Download high-resolution press photos and press kit for media use.
        </p>

        {/* Press Kit Download */}
        <div className="mb-16">
          <div className="bg-gray-900 p-8 rounded-lg border border-gray-800 hover:border-accent-orange transition-all duration-300 max-w-2xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-accent-orange rounded-lg flex items-center justify-center">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-heading text-white">Press Kit 2025</h3>
                  <p className="text-gray-400 text-sm">Complete press information, bio, and technical rider</p>
                </div>
              </div>
              <a
                href="/press/IBRAHIM ELECTRIC press 2025.pdf"
                download="Ibrahim-Electric-Press-Kit-2025.pdf"
                className="bg-gradient-to-r from-accent-orange to-accent-amber text-white px-8 py-3 rounded-full font-bold btn-modern transition-all duration-300 hover:scale-110 hover:shadow-2xl whitespace-nowrap"
              >
                Download PDF
              </a>
            </div>
